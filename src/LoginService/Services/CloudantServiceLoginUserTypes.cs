...
{
    public class CloudantServiceLoginUserTypes : ICloudantServiceLoginUserTypes
    {
        private static readonly string _dbName = "loginusertypes";//"LoginUserTypes";
        private readonly Creds _cloudantCreds;
        private readonly UrlEncoder _urlEncoder;
        private readonly IHttpClientFactory _factory;

        public CloudantServiceLoginUserTypes(Creds creds, UrlEncoder urlEncoder, IHttpClientFactory factory)
        {
        ...
        public async Task<dynamic> CreateAsync(LoginUserTypesAddRequest item)
        {
        ...
        public async Task<dynamic> UpdateAsync(LoginUserTypes item)
        {
            string jsonInString = JsonConvert.SerializeObject(item);
