...
namespace employeeservice.Controllers
{
    ...
    public class LoginUserTypesController : Controller
    {
        private readonly HtmlEncoder _htmlEncoder;
        private readonly ICloudantServiceLoginUserTypes _cloudantService;

        public LoginUserTypesController(HtmlEncoder htmlEncoder, ICloudantServiceLoginUserTypes CloudantServiceLoginUserTypes = null)
        {
            _cloudantService = CloudantServiceLoginUserTypes;
        ...
        [HttpPost]
        public async Task<dynamic> Post([FromBody]LoginUserTypesAddRequest loginuserType)
        {
            if (_cloudantService != null)
            {
                return await _cloudantService.CreateAsync(loginuserType);
        ...
        [HttpPut]
        public async Task<dynamic> Update([FromBody]LoginUserTypes loginusertype)
        {
            if (_cloudantService != null)
            {
